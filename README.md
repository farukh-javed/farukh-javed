...
<p align="right">
    ...
    <style>
        .heavy { font: bold 18px Georgia; }
    </style>
    <text x="10" y="20" class="heavy" fill="#FF5733">Farukh Javed</text> <!-- Orange -->
    <text x="10" y="40" class="heavy" fill="#33FF57">AI Enthusiast | Software Engineer</text> <!-- Green -->
    <text x="10" y="60" class="heavy" fill="#3357FF">Deep Learning | Generative AI | LangChain</text> <!-- Blue -->
</svg>
</p>
